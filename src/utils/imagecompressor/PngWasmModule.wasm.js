/* @vite-ignore */
import pngWasmBinaryFile from "./png.wasm?url";

export let Module;
if (!Module) {
	Module = (typeof Module !== "undefined" ? Module : null) || {
		wasmBinaryFile: pngWasmBinaryFile,
	};
}
...
function integrateWasmJS() {
	...
	var wasmTextFile = Module["wasmTextFile"] || "image_compressor.wast";
	var wasmBinaryFile = Module["wasmBinaryFile"] || "image_compressor.wasm";
	var asmjsCodeFile = Module["asmjsCodeFile"] || "image_compressor.temp.asm.js";
